...
activities = {
    ...
    "Soccer Team": {
        "description": "Team soccer practice and competitive matches",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, script reading, and performance practice",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["harper@mergington.edu", "jack@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Practice challenging math problems and competition prep",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["oliver@mergington.edu", "amelia@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments and science fair project planning",
